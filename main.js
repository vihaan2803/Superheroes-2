    ...
    fabric.Image.fromURL(get_image,
         function(Img) { 
             block_image_object = Img;
              block_image_object.scaleToWidth(superhero_image_width); 
              block_image_object.scaleToHeight(superhero_image_height); 
...
function my_keydown(e) { 
    ...
    if(e.shiftKey == true && keyPressed == '80') {
         ...
         block_image_height = block_image_height + 10; document.getElementById("current_width").innerHTML = block_image_width; document.getElementById("current_height").innerHTML = block_image_height; }
